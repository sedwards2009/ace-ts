...
const modes: Mode[] = [
    ...
    new Mode("css", "CSS", "css", ["text/css"], "CssMode"),
    ...
    new Mode("haskell", "Haskell", "hs", ["text/x-haskell"], "HaskellMode"),
    new Mode("haxe", "haXe", "hx", ["text/x-haxe"]),
    new Mode("html", "HTML", "html|htm|xhtml", ["text/html"], "HtmlMode"),
    ...
    new Mode("jsx", "JSX", "jsx", ["text/jsx"], "JsxMode"),
    new Mode("julia", "Julia", "jl", ["text/x-julia"]),
    new Mode("latex", "LaTeX", "tex|latex|ltx|bib", ["text/x-latex"], "LatexMode"),
    new Mode("less", "LESS", "less", ["text/x-less"]),
    new Mode("liquid", "Liquid", "liquid", ["text/x-liquid"]),
    new Mode("lisp", "Lisp", "lisp", ["text/x-lisp"], "LispMode"),
    ...
    new Mode("matlab", "MATLAB", "matlab", ["text/x-matlab"], "MatlabMode"),
