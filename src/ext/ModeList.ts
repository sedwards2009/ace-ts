...
const modes: Mode[] = [
    ...
    new Mode("autohotkey", "AutoHotKey", "ahk", []),
    ...
    new Mode("jsoniq", "JSONiq", "jq", []),
    new Mode("jsp", "JSP", "jsp", []),
    ...
    new Mode("lisp", "Lisp", "lisp", []),
    new Mode("livescript", "LiveScript", "ls", ["text/x-livescript"]),
    new Mode("logiql", "LogiQL", "logic|lql", []),
    new Mode("lsl", "LSL", "lsl", []),
    new Mode("lua", "Lua", "lua", ["text/x-lua"]),
    new Mode("luapage", "LuaPage", "lp", []),
    new Mode("lucene", "Lucene", "lucene", []),
    new Mode("makefile", "Makefile", "^Makefile|^GNUmakefile|^makefile|^OCamlMakefile|make", []),
    new Mode("markdown", "Markdown", "md|markdown", ["text/x-markdown"]),
    new Mode("matlab", "MATLAB", "matlab", []),
    new Mode("mel", "MEL", "mel", []),
    new Mode("mushcode", "MUSHCode", "mc|mush", []),
    new Mode("mysql", "MySQL", "mysql", ["text/x-mysql"]),
    new Mode("nix", "Nix", "nix", []),
    ...
    new Mode("prolog", "Prolog", "plg|prolog", []),
    new Mode("properties", "Properties", "properties", []),
    new Mode("protobuf", "Protobuf", "proto", ["text/x-protobuf"]),
    new Mode("python", "Python", "py", ["text/x-python"]),
    new Mode("r", "R", "r", ["text/x-rsrc"]),
    new Mode("rdoc", "RDoc", "Rd", []),
    new Mode("rhtml", "RHTML", "Rhtml", []),
    ...
    new Mode("sh", "SH", "sh|bash|^.bashrc", []),
    new Mode("sjs", "SJS", "sjs", []),
    new Mode("smarty", "Smarty", "smarty|tpl", ["text/x-smarty"]),
    new Mode("snippets", "snippets", "snippets", []),
    new Mode("soy_template", "Soy Template", "soy", []),
